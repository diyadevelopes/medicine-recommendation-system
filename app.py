...
# Load the model
model = pickle.load(open("C:/Users/diyad/OneDrive/Desktop/Medicine_Recommendation/model/svc.pkl", 'rb'))
...
def helper(dis):
    ...
    pre = pre.fillna('No data available').values.flatten().tolist()  # Flatten to a simple list
    
    # Get medications
    med = medications[medications['Disease'] == dis]['Medication']
    med = med.fillna('No data available').tolist()
    
    # Get diets
    die = diets[diets['Disease'] == dis]['Diet']
    die = die.fillna('No data available').tolist()
    
    # Get workouts
    wrkout = workout[workout['disease'] == dis]['workout']
    wrkout = wrkout.fillna('No data available').tolist()
...
st.markdown("Select symptoms to get predicted disease and suggestions.")
...
if st.button("Predict"):
    if not selected_symptoms:
        ...
        predicted_index = given_predicted_value(selected_symptoms)
